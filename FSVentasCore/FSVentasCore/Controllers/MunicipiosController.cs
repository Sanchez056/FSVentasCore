...
namespace FSVentasCore.Controllers
{
    public class MunicipiosController : Controller
    {
        ...
        {
            var fSVentasCoreDb = _context.Municipios.Include(m => m.Ciudades).Include(m => m.Provincias);
        ...
        public async Task<IActionResult> Create([Bind("MunicipioId,Nombre,ProvinciaId,CiudadId")] Municipios municipios)
        {
